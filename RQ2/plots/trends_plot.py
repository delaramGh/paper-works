...
plt.xlabel("Accuracy %")
plt.ylabel("Human Effort %")
plt.legend()
plt.title("Humman Effort vs. Accuracy w.r.t. split_1 for SmartInside Dataset\nthreshold=.9, split_2=.05")
plt.grid(True)
plt.show()
